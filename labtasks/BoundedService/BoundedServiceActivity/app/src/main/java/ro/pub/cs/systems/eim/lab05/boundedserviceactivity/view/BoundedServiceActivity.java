...
public class BoundedServiceActivity extends AppCompatActivity {
    ...
    private GetMessageFromServiceButtonListener buttonListener = new GetMessageFromServiceButtonListener();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getMessageFromServiceButton.setOnClickListener(buttonListener);
    }
